...
def _fetch_gupy_search_page(search_url: str) -> str:
    # Em ambientes serverless (ex.: Vercel), o binário do Playwright pode não existir.
    # Tentamos Playwright primeiro e, se indisponível, caímos para requisição HTTP direta.
    try:
